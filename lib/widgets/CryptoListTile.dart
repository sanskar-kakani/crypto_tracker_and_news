  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: Column(
        ...
        children: [
          Text("₹ " + currentCrypto.currentPrice!.toStringAsFixed(2), style: const TextStyle(
          ...
          Builder(
            builder: (context) {
              ...
              if(priceChange < 0) {
                // negative
                return Text("${priceChangePercentage.toStringAsFixed(2)}% (${priceChange.toStringAsFixed(2)})", style: const TextStyle(
                  color: Colors.red
                ),);
              }
              else {
